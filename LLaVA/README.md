...
Using vision encoder google/siglip (Llava uses openai/clip), see llava/model/multimodal_encoder to check the detail.

Using BLEU benchmark to infer and evaluate results that infered from VLSP 2023 test data (check eval.py)
